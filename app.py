...
if uploaded_file is not None:
    ...
    # ==============================
    # Precompute EMAs (FAST VERSION)
    # ==============================

    st.info("⚡ Precomputing EMAs for faster optimization...")

    ema_cache = {}

    max_period = max(slow_range)

    for period in range(2, max_period + 1):
        ema_cache[period] = ta.trend.ema_indicator(data["Close"], window=period)
        ...
        for fast in fast_range:
            ...
            for slow in slow_range:
                ...
                for signal in signal_range:
                    ...
                    # FAST MACD using cached EMAs
                    macd_line = ema_cache[fast] - ema_cache[slow]
